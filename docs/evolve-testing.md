...
`python3 scripts/evolve/evals.py` — now a 20-scenario catalog (S01-S20), documented in `docs/evolve-scenarios.md`; offline scenarios run free in local mode, `--mode honcho --runs 3` for the §7 deriver bar.
