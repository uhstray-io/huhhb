...
> **[TARGET] — not yet true.** No requirement here is implemented. `.mcp.json`
> still registers a retired backend for every installer and all four legacy
> skills still ship. Tracked by the `retire-mempalace` change (0/22). Do not
