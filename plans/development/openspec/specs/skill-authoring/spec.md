...
> **Partially as-built.** The nine requirements from `skill-authoring-standard`
> are implemented; the four added by `skill-retrofit` (0/21) are **[TARGET]** —
> S9–S12 are WARN, not blocking, until that burndown empties the lint baseline.
