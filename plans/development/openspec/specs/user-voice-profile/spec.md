# user-voice-profile Specification

## Purpose
Defines the user-level voice profile: the interview that elicits it, the
evidence that grounds it, the block that carries it, and the write contract
that keeps installing it safe and idempotent.
