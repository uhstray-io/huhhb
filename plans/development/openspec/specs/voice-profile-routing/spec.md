# voice-profile-routing Specification

## Purpose
Governs where a stated preference is written — the user's own configuration,
the experience store, or nowhere — and the gates that protect an existing
configuration from a careless write.
